...
const {RATEMODE_STABLE, RATEMODE_NONE, RATEMODE_VARIABLE} = require('../../utils/constants');
...
module.exports = {executeStory};

const executeStory = async (story, users) => {
  for (const action of story.actions) {
    await executeAction(action, users);
  }
};

const executeAction = async (action, users) => {
