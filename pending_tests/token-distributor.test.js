...
contract('TokenDistributor', async ([deployer, ...users]) => {
  let _testEnvProvider, _tokenDistributorInstance,
  TokenDistributorInstance,_tokenInstances,_web3,_depositorAddress,
  _daiDistributionParams, _lendDistributionParams, _ethDistributionParams;
