...
/// @title PopulousPropositionPower
/// @author Populous World
/// @notice Asset to control the permissions on the actions in PopulousProtoGovernance, like:
///  - Register a new Proposal
contract PopulousPropositionPower is ERC20Capped, ERC20Detailed {
