...
import "../interfaces/IPopulousProtoGovernance.sol";


/// @title PopulousProtoGovernance
/// @author Populous
...
///  - The creation of a new proposal can only be triggered by an account with a certain amount of PopulousPropositionPower
contract PopulousProtoGovernance is IPopulousProtoGovernance {
    ...
    /// @notice Smart contract holding the global parameters needed in this PopulousProtoGovernance
    ...
    ///  - Allowed only for holders of PopulousPropositionPower with more than 100/propositionPowerThreshold % of the total supply
