...
module.exports = function (deployer, network, accounts) {
    ...
    if (network == "development") {
        ...
        deployer.deploy(LendingPoolConfigurator, { gas: 6721975, from: root, overwrite: true });
    } else {
        // Perform a different step otherwise.
        deployer.deploy(LendingPoolConfigurator, { gas: 6721975, from: root, overwrite: false });
    }
};